  ...
  return (
    <footer className="relative flex flex-col items-center justify-center gap-6 px-5 w-full bg-white py-6">
      <div className="first w-full flex flex-wrap items-start justify-between gap-6">
        ...
        {/* Navigation Lists */}
        <nav className="lists flex flex-wrap gap-6 justify-center lg:justify-between w-full lg:w-auto lg:mr-10">
          <div className="about">
            <ul className="flex flex-col gap-1">
              <li className="font-bold text-lg"><h2>About</h2></li>
              <li>How it works</li>
              <li>Featured</li>
              <li>Partnership</li>
          ...
          <div className="community">
            <ul className="flex flex-col gap-1">
              <li className="font-bold text-lg"><h2>Community</h2></li>
              <li>Events</li>
              <li>Blog</li>
              <li>Podcast</li>
          ...
          <div className="socials">
            <ul className="flex flex-col gap-1">
              <li className="font-bold text-lg"><h2>Socials</h2></li>
              <li>Discord</li>
              <li>Instagram</li>
              <li>Facebook</li>
              <li>Twitter</li>
